...
// for now make quirks_set and extra_bootargs writable for rpi4 0xC03111 test-boot.scr handling
 ...
 * This means in this case extra_bootargs and quirks_set may not be preset by omnect_env*.h
 */
