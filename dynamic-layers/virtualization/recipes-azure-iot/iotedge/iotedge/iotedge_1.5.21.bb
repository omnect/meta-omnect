...
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/aziot-key-client"
...
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/aziot-key-openssl-engine"
...
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/aziot-keys-common"
SRCREV_FORMAT .= "_aziot-tpmd-config"
SRCREV_aziot-tpmd-config = "main"
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/aziot-tpmd-config"
SRCREV_FORMAT .= "_aziotctl-common"
SRCREV_aziotctl-common = "main"
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/aziotctl-common"
...
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/cert-renewal"
...
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/config-common"
...
SRCREV_logger = "main"
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/logger"
...
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/openssl-build"
...
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/openssl-sys2"
SRCREV_FORMAT .= "_openssl2"
SRCREV_openssl2 = "main"
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/openssl2"
...
SRCREV_pkcs11 = "main"
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/pkcs11"
SRCREV_FORMAT .= "_pkcs11-sys"
SRCREV_pkcs11-sys = "main"
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/pkcs11-sys"
...
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/test-common"
