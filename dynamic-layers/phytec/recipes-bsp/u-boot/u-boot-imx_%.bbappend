...
# imx-atf and u-boot are part of imx-boot (imx-boot recipe is more or less copying thus currently not reflected here)
...
# do we want to regard imx-boot-phytec as well? theoretically
