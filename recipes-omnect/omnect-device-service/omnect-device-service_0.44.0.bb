...
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/http-common"
...
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/modemmanager"
SRCREV_FORMAT .= "_modemmanager-sys"
SRCREV_modemmanager-sys = "0.1.4"
EXTRA_OECARGO_PATHS += "${UNPACKDIR}/modemmanager-sys"
