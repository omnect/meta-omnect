...
# SRC_URI += "crate://crates.io/omnect-device-service/0.19.4"
SRC_URI += "git://github.com/omnect/omnect-device-service.git;protocol=https;nobranch=1;branch=main"
SRCREV = "861b8fa9e580a1364d47d5c0891edeacbada573f"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = ""
...
SRC_URI += " \
    ...
    crate://crates.io/actix-web/4.6.0 \
    ...
    crate://crates.io/async-signal/0.2.7 \
    ...
    crate://crates.io/regex-lite/0.1.5 \
