...
SRC_URI += "git://github.com/JanZachmann/omnect-device-service.git;protocol=https;nobranch=1;branch=report-network"
SRCREV = "e89eb520ceaf662687312f1e13f144f03b15c0f6"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = ""
PV:append = ".AUTOINC+e89eb520ce"
...
SRC_URI += " \
    ...
    crate://crates.io/wasm-bindgen-futures/0.4.39 \
