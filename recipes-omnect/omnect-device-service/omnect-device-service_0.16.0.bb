...
# SRC_URI += "crate://crates.io/omnect-device-service/0.16.0"
SRC_URI += "git://github.com/mlilien/omnect-device-service.git;protocol=https;nobranch=1;branch=update_validation_improvements"
SRCREV = "2d4c010c49dae4a796d1ac6f229d9b03fbb891a8"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = ""
PV:append = ".AUTOINC+2d4c010c49"
...
SRC_URI += " \
    ...
    crate://crates.io/bindgen/0.69.1 \
