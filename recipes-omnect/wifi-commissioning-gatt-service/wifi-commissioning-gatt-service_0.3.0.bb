...
# SRC_URI += "crate://crates.io/wifi-commissioning-gatt-service/0.3.0"
SRC_URI += "git://git@github.com/omnect/wifi-commissioning-gatt-service.git;protocol=ssh;nobranch=1;branch=main"
SRCREV = "2421b76a0d717315f774b0f3dacd4af7f36d892a"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = ""
PV:append = ".AUTOINC+2421b76a0d"
...
SRC_URI += " \
    ...
    crate://crates.io/dbus-crossroads/0.5.1 \
