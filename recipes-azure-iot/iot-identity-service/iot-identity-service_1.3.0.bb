...
SRC_URI = "gitsm://git@github.com/Azure/iot-identity-service.git;protocol=https;nobranch=1;tag=1.3.0"

SRC_URI += " \
    file://iot-identity-service-certd.template.toml \
    file://tpm-compile-fix.patch \
    file://ossl300_fix_incompatible_pointer_types.patch \
    file://ossl300_aziot-tpm-sys.patch \
...
SRC_URI += " \
    ...
    crate://crates.io/crypto-common/0.1.4 \
    ...
    crate://crates.io/erased-serde/0.3.21 \
    ...
    crate://crates.io/wildmatch/1.1.0 \
