...
# SRC_URI += "crate://crates.io/iot-module-template-rs/0.2.0"
SRC_URI += "git://git@github.com/ICS-DeviceManagement/iot-module-template-rs.git;protocol=ssh;nobranch=1;branch=main"
SRCREV = "08b1e9aa392c9bed65b846bd99c8931ee79070d1"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = ""
PV_append = ".AUTOINC+08b1e9aa39"
...
SRC_URI += " \
    ...
    crate://crates.io/serde/1.0.135 \
    crate://crates.io/serde_derive/1.0.135 \
