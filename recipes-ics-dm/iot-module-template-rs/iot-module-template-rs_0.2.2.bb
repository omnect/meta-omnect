...
#
# Manually adapted: fetch eis-utils with git submodule fetcher
inherit cargo
...
SRC_URI += " \
    ...
    gitsm://git@github.com/ICS-DeviceManagement/eis-utils.git;protocol=ssh;nobranch=1;name=eis-utils;destsuffix=eis-utils \
