...
do_cyclonedx() {
    ...
    ${STAGING_BINDIR_NATIVE}/cargo-cyclonedx cyclonedx --manifest-path ${CARGO_MANIFEST_PATH} ${CYCLONEDX_FEATURES} --target ${RUST_TARGET_SYS} --spec-version 1.5 --format json
}
